...
/**
 * This function is used to generate chunks from text
 * It will return an array of objects with the chunks
 *
 * @param text - The text to generate chunks from
 * @returns An array of objects with the chunks
 */
