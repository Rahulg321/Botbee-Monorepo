...
const EditCharacterForm = ({
  ...
  characterFullDescription,
  characterPersonality,
  characterBehaviorAndTone,
  characterConversationTone,
  characterSystemPrompt,
  characterBrandGuidelines,
  characterCustomGreeting,
  characterPrompts,
  characterCategoryId,
  characterStatus,
}: {
  ...
  characterFullDescription: string;
  characterPersonality: string;
  characterBehaviorAndTone: string;
  characterConversationTone: string;
  characterSystemPrompt: string;
  characterBrandGuidelines: string;
  characterCustomGreeting: string;
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      behaviorAndTone: characterBehaviorAndTone,
      conversationTone: characterConversationTone,
      brandGuidelines: characterBrandGuidelines,
      customGreeting: characterCustomGreeting,
  ...
  const onSubmit = (values: EditCharacterInput) => {
    console.log(values);
